...
//encontrar elemento li
function adcClasse (event){
    let classeTech = document.querySelector('.tech');
    // remove a classe tech do elemento clicado anteriormente
    classeTech.classList.remove('tech')
    //adiciona a classe tech no novo elemento clicado
...
// com a classe 'tech';
firstLi.addEventListener('click',adcClasse);
